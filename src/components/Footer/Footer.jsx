...
export default function Footer() {
    ...
    return (
        <div className='flex justify-center'>
            <div className=' w-[350px] sm:w-[1000px] px-[1rem] py-[5rem] sm:flex sm:justify-between'>
                <div>

                    {/* dimenciones para pantalla chica */}
                    <div className='flex justify-center sm:hidden'>
                        <Curriculum color='black' py='.5rem' px='5rem' />
                    </div>
                ...
                <div className='mt-[3rem] sm:mt-[0] flex-col justify-center items-center  sm:px-[10rem]'>

                    <div className='flex items-center mt-[.5rem] justify-center'><Social /></div>
