  ...
  return (
    <>
      ...
      <div className=' mt-[90px] text-center'>
        ...
        <h2 className='text-[22px] uppercase text-[#bbc8dd] typing-effect'>Desarrollador Full Stack</h2>
      </div>
      
      <div className='flex justify-center items-center mt-[50px]'>
        <div className=' z-20 profile-pic'>
          <img src="./avp-square-pic.png" alt="" className='rounded-full h-[248px] w-[244px]' />
        </div>
      </div>
